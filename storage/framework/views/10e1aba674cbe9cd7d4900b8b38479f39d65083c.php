                  ...
                  <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                     <div class="card-body">
                        <a href="<?php echo e(route('dashboard')); ?>" class="navbar-brand d-flex align-items-center mb-3">
                           ...
                           <h4 class="logo-title ms-3">EcoTour</h4>
                        </a>
...
<?php endif; ?>
                        <form method="POST" action="<?php echo e(route('login')); ?>" data-toggle="validator">
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <input id="email" type="email" name="email"  value="<?php echo e(env('IS_DEMO') ? 'admin@example.com' : old('email')); ?>"   class="form-control"  placeholder="admin@example.com" required autofocus>
                                 </div>
                              </div>
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    <label for="password" class="form-label">Password</label>
                                    <input class="form-control" type="password" placeholder="********"  name="password" value="<?php echo e(env('IS_DEMO') ? 'password' : ''); ?>" required autocomplete="current-password">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                              ...
                              <div class="col-lg-6">
                                 <a href="<?php echo e(route('auth.recoverpw')); ?>"  class="float-end">Forgot Password?</a>
                              </div>
                           </div>
                           ...
                           <p class="mt-3 text-center">
                              Don’t have an account? <a href="<?php echo e(route('register')); ?>" class="text-underline">Click here to sign up.</a>
                           </p>
                        </form>
                     </div>
                  </div>
...
<?php endif; ?>
<?php /**PATH C:\projects\tourism\resources\views/auth/login.blade.php ENDPATH**/ ?>
   ...
   <div class="row">
                     ...
                     <div class="card-body">
                        <div class="progress-widget">
                           ...
                           <div class="progress-detail">
                              ...
                              <h4 class="counter" style="visibility: visible;">$1.2M</h4>
                           </div>
                        </div>
                     </div>
                  </li>
      ...
      <div class="col-md-12 col-lg-8">
                    ...
                    <div class="card" data-aos="fade-up" data-aos-delay="800">
                        <div class="card-header d-flex justify-content-between flex-wrap">
                            <div class="header-title">
                                <h4 class="card-title" id="sales-output">$855.8K</h4>
                        ...
                        <div class="card-body">
                            <div class="input-group mb-3">
                                <input type="date" id="date-input" class="form-control" placeholder="Select a date" aria-label="Select a date">
                                <button class="btn btn-primary" id="predict-btn">Predict</button>
                            </div>
                            <div id="output" class="mt-3">
                                <p><strong>Best Destination:</strong> <span id="best-destination">N/A</span></p>
                                <p><strong>Best Event:</strong> <span id="best-event">N/A</span></p>
                                <p><strong>Predicted Travelers:</strong> <span id="predicted-travelers">N/A</span></p>
                            </div>
        ...
        document.getElementById('predict-btn').addEventListener('click', function() {
            ...
            // Call your API here using POST method
            ...
            .then(data => {
                ...
                document.getElementById('best-destination').textContent = data.best_destination;
                document.getElementById('best-event').textContent = data.best_event;
                document.getElementById('predicted-travelers').textContent = data.predicted_travelers;
            })
            .catch(error => {
                        ...
                        <table id="basic-table" class="table table-striped mb-0" role="grid">
                           ...
                           <tbody>
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="<?php echo e(asset('images/shapes/01.png')); ?>" alt="profile">
                                       <h6>Active Adventures	</h6>
                                    </div>
                                 </td>
                                 <td>
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="<?php echo e(asset('images/shapes/05.png')); ?>" alt="profile">
                                       <h6>Eco Tours International</h6>
                                    </div>
                                 </td>
                                 <td>
                                    <div class="iq-media-group iq-media-group-1">
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="<?php echo e(asset('images/shapes/02.png')); ?>" alt="profile">
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="<?php echo e(asset('images/shapes/03.png')); ?>" alt="profile">
                                       <h6>Luxury Escapes	</h6>
                                    </div>
                                 </td>
                                 <td>
                                    <div class="iq-media-group iq-media-group-1">
                              ...
                              <tr>
                                 <td>
                                    <div class="d-flex align-items-center">
                                       <img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="<?php echo e(asset('images/shapes/04.png')); ?>" alt="profile">
                                       <h6>Family Fun Travel</h6>
                                    </div>
                                 </td>
                                 <td>
                                    <div class="iq-media-group iq-media-group-1">
         ...
         <div class="row">
                  ...
                  <div class="card-body">
                     <div class="d-flex align-itmes-center flex-wrap  mb-4">
                        <div class="d-flex align-itmes-center me-0 me-md-4">
                           ...
                           <div class="ms-3">
                              <h5>1153</h5>
                              <small class="mb-0">Insights</small>
                           </div>
                        </div>
                        <div class="d-flex align-itmes-center">
                           ...
                           <div class="ms-3">
                              <h5>81K</h5>
                              <small class="mb-0">Total Travel Packages</small>
                           </div>
                        </div>
                     </div>
                     <div class="mb-4">
            ...
            <div class="col-md-12 col-lg-12">
               <div class="card" data-aos="fade-up" data-aos-delay="400">
                  <div class="card-header d-flex justify-content-between flex-wrap">
                     <div class="header-title">
                        <h4 class="card-title mb-2">Activity Log</h4>
                        <p class="mb-0">
                           <svg class ="me-2" width="24" height="24" viewBox="0 0 24 24">
                  ...
                  <div class="card-body">
                     <div class=" d-flex profile-media align-items-top mb-2">
                        ...
                        <div class="ms-4">
                           <h6 class=" mb-1">$2,400: Booking made</h6>
                     ...
                     <div class=" d-flex profile-media align-items-top mb-2">
                        <div class="profile-dots-pills border-primary mt-1"></div>
                        <div class="ms-4">
                           <h6 class=" mb-1">New booking #8744152</h6>
                     ...
                     <div class=" d-flex profile-media align-items-top mb-2">
                        <div class="profile-dots-pills border-primary mt-1"></div>
                        <div class="ms-4">
                           <h6 class=" mb-1">Affiliate commission processed</h6>
                     ...
                     <div class=" d-flex profile-media align-items-top mb-2">
                        <div class="profile-dots-pills border-primary mt-1"></div>
                        <div class="ms-4">
                           <h6 class=" mb-1">New traveler registered</h6>
                     ...
                     <div class=" d-flex profile-media align-items-top mb-1">
                        <div class="profile-dots-pills border-primary mt-1"></div>
                        <div class="ms-4">
                           <h6 class=" mb-1">New tour package added</h6>
...
<?php endif; ?>
<?php /**PATH C:\projects\tourism\resources\views/dashboards/dashboard.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
    <div class="edit-restaurant-content">
        ...
        <form action="<?php echo e(route('restaurants.update', $restaurant->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <div class="mb-3">
                <label for="name" class="form-label"><strong>Restaurant Name:</strong></label>
                <input type="text" class="form-control" name="name" id="name" value="<?php echo e($restaurant->name); ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="cuisine_type" id="cuisine_type" required>
                    ...
                    <option value="French" <?php echo e($restaurant->cuisine_type == 'French' ? 'selected' : ''); ?>>French</option>
                    <option value="Italian" <?php echo e($restaurant->cuisine_type == 'Italian' ? 'selected' : ''); ?>>Italian</option>
                    <option value="Chinese" <?php echo e($restaurant->cuisine_type == 'Chinese' ? 'selected' : ''); ?>>Chinese</option>
                    <option value="Japanese" <?php echo e($restaurant->cuisine_type == 'Japanese' ? 'selected' : ''); ?>>Japanese</option>
                    <option value="Indian" <?php echo e($restaurant->cuisine_type == 'Indian' ? 'selected' : ''); ?>>Indian</option>
            ...
            <div class="mb-3">
                ...
                <?php if($restaurant->restaurant_image): ?>
                    <div class="image-preview mt-3">
                        <img src="<?php echo e(asset('storage/' . $restaurant->restaurant_image)); ?>" alt="Restaurant Image" class="img-fluid img-thumbnail">
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="address" id="address" value="<?php echo e(preg_replace('/\s*\(Lat:.*?Lng:.*?\)\s*/', '', $restaurant->address)); ?>" required>
            </div>
            ...
            <input type="hidden" name="latitude" id="latitude" value="<?php echo e($restaurant->latitude); ?>">
            <input type="hidden" name="longitude" id="longitude" value="<?php echo e($restaurant->longitude); ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const lat = <?php echo e($restaurant->latitude ?? 36.835668247244406); ?>;
            const lng = <?php echo e($restaurant->longitude ?? 10.303136514168322); ?>;
            ...
            const marker = L.marker([lat, lng]).addTo(map)
                .bindPopup("<b><?php echo e($restaurant->name); ?></b><br><?php echo e(preg_replace('/\s*\(Lat:.*?Lng:.*?\)\s*/', '', $restaurant->address)); ?>")
                .openPopup();
...
<?php endif; ?>
<?php /**PATH C:\projects\tourism\resources\views/restaurants/edit.blade.php ENDPATH**/ ?>
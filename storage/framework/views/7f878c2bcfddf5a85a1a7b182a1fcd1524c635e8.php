...
<?php $component->withAttributes([]); ?>
    <div class="container">
        ...
        <form action="<?php echo e(route('guides.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3 text-center">
                ...
                <a href="<?php echo e(route('guides.index')); ?>" class="btn btn-secondary">Annuler</a>
            </div>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\projects\tourism\resources\views/guide/create.blade.php ENDPATH**/ ?>